...
function CurrentlyReading(props) {
  const user_id = props.token.user.id 
          ...
          <Box className="flex justify-evenly gap-x-5 mr-10">
            ...
            <Box className="font-light">
              ...
              <Typography
                ...
                variant="p"
              >
                {userBookData?.page_progress ? userBookData.page_progress : "loading"} of {currentBook?.number_of_pages ? currentBook.number_of_pages : "loading"}
              </Typography>
