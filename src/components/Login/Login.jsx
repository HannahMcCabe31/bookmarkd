                ...
                <Container maxWidth="lg" className=" md:mb-[-4rem]">
                    <Box className=" md:ml-[-10rem] lg:ml-[-20rem]">
                        <Box className="md:hidden">
                            ...
                            >
                                ...
                                <Typography
                                    ...
                                    className="m-5"
                                >
                                    Register for a free account to use all of
                                    the site features
                                </Typography>
                                <Typography
                                    variant="p"
                                ...
                                <Box textAlign="center">
                                    <Typography
                                        variant="terms"
                                        color="white.main"
                                        className="p-2 pl-10 pr-10 fixed bottom-0 left-0 w-full flex justify-between items-center text-[1rem] self-center"
                                    >
                                        {" "}
                                        By clicking &quot;Continue with
                                        Email/Apple/Google/X&quot; above, you
                                        agree to bookmarkd&apos;s Terms &
                        ...
                        <Box className="hidden md:block m-0 p-0  ">
                            ...
                            >
                                book
                                <span className="text-star-blue p-0 m-0">
                                    mark
                                </span>
                                d
                            </Typography>
                            ...
                            <Box className=" bg-[#14191d] flex items-center justify-center ">
                                <Box className="bg-white shadow-[0_5px_15px_rgba(0,0,0,0.35)]  overflow-hidden min-h-[500px] rounded-[30px] w-[44rem] h-[32rem]">
                                    <Box className="flex justify-center">
                                        ...
                                        <Box
                                            className={`flex justify-center  w-[100%] h-[100%] `}
                                        >
                                            <form className="bg-white flex flex-col justify-center ">
                                                <Typography
                                                    variant="h1"
                        ...
                        <Box className="text-white hidden md:flex justify-center w-[45%] m-auto text-center mt-3 opacity-90 ">
                            ...
                            <Typography variant="p" className="text-[1.1rem]">
                                ...
                                above, you agree to Bookmarkd's{" "}
                                <span
                        ...
                        <div className="mx-auto text-center mt-4 border-2 border-heart-red border-rounded-2xl w-[50%]">
                                <Button
                                    variant="outline"
                        ...
                        >
                            ...
                            <Box textAlign="center">
                                <Typography
                                    variant="terms"
                                    color="white.main"
                                    className="p-2 pl-10 pr-10 fixed bottom-0 left-0 w-full flex justify-between items-center text-[1rem]"
                                >
                                    {" "}
                                    By clicking &quot;Continue with
                                    Email/Apple/Google/X&quot; above, you agree
                                    to bookmarkd&apos;s Terms & Conditions and
                                    Privacy Policy
                                </Typography>
                            </Box>
                        </Box>
