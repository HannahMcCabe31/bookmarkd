          ...
          <Box className="flex flex-col items-center">
            ...
            <form className="text-center" onSubmit={handleSearch}>
              <SearchPageBar
                ...
                className=" bg-element-blue border-element-blue rounded-[5vw] m-0 mt-[10vw] p-0 w-[60vh] md:mt-[5vh] md:w-[80vh] md:p-[0.2rem] md:mb-[5vh]"
