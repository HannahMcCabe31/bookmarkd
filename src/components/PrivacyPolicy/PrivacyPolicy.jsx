  ...
  return (
    <>
      ...
      <Typography className="text-white" variant="body2">
        ...
        <Typography variant="body2">
          Information from third-party sources. We may collect information about
        ...
        <Typography variant="body2">
          To provide our services. We use your information to provide you with
        ...
        <Typography variant="body2">
          To send you marketing communications. We may use your information to
        ...
        <Typography variant="body2">
          Disclosure of Your Information We may disclose your information to the
        ...
        <Typography variant="body2">
          Third-party partners. We may share your information with third-party
        ...
        <Typography variant="body2">
          Your Choices You have the following choices regarding your
