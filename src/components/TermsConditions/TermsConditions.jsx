      ...
      <ThemeProvider theme={bookmarkd}>
        ...
        <Box className="mx-8">
          ...
          <Typography variant="body2" className="text-white">
            ...
            <Typography variant="body2">2. Account Registration </Typography>
            ...
            <Typography variant="body2">
              ...
              agree to notify Bookmarkd immediately of any unauthorized use of
              your account.
            </Typography>

            <Typography variant="body2">3. User Conduct </Typography>
            <Typography variant="body2">
              You agree to use the Services in a manner that is lawful,
              non-discriminatory, and respectful of others. You agree not to use
              the Services to: Post or transmit any material that is illegal,
              harmful, threatening, abusive, harassing, tortious, defamatory,
              vulgar, obscene, libelous, invasive of another's privacy, hateful,
              or racially, ethnically, or otherwise objectionable. Post or
              transmit any material that contains software viruses, Trojan
              horses, worms, or other harmful components. Interfere with or
              disrupt the Services or servers or networks connected to the
              Services. Use any device, software, or routine that interferes
              with the proper working of the Services. Attempt to gain
              unauthorized access to the Services or any part thereof.
            </Typography>
            ...
            <Typography variant="body2">
              ...
              distribute, display, perform, or create derivative works from any
              of the content without the prior written consent of Bookmarkd.
            </Typography>
            <Typography variant="body2">
              5. Third-Party Links The Services may contain links to third-party
              websites or services that are not owned or controlled by
              Bookmarkd. Bookmarkd has no control over, and assumes no
              responsibility for, the content, privacy policies, or practices of
              any third-party websites or services. You further acknowledge and
              agree that Bookmarkd shall not be responsible or liable, directly
            ...
            <Typography variant="body2">
              ...
              IS" AND "AS AVAILABLE" BASIS. BOOKMARKD DISCLAIMS ALL WARRANTIES,
              EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, THE IMPLIED
              WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE,
              AND NON-INFRINGEMENT. BOOKMARKD DOES NOT WARRANT THAT THE SERVICES
            ...
            <Typography variant="body2">
              ...
              agents, from and against all claims, liabilities, damages, losses,
            ...
            <Typography variant="body2">
              9. Governing Law These Terms shall be governed by and construed in
            ...
            <Typography variant="body2">
              13. Amendments Bookmarkd may modify these Terms from time to time.
              ...
              responsible for reviewing the updated Terms and agreeing to them
              before
            </Typography>
          </Typography>
        </Box>
